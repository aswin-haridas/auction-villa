  ...
  return (
    <div>
      <div className="flex space-x-4 mr-28 ">
        ...
        <input type="number" placeholder="Custom Amount" className="border-2 border-red-600 placeholder-gray-500 font-bold px-2 bg-transparent text-white h-10 rounded-sm " />
      </div>
      ...
      <div className="flex space-x-4 mr-28 mt-6">
        ...
        <div className="cursor-pointer group relative flex flex-col text-center justify-center font-bold border-2 border-red-800 w-60 h-10 text-cyan-300 rounded-sm overflow-hidden">
        ...
        <div className="cursor-pointer flex flex-col text-center justify-center font-bold border-2 border-red-800 w-48 h-10 text-gray-500 rounded-sm hover:text-gray-400">Leave</div>
      </div>
    </div>
  );
};
